...
export declare namespace ElementDefinitionType {
    type VersioningEnum = 'either' | 'independent' | 'specific';
    const VersioningEnum: {
        Either: VersioningEnum;
        Independent: VersioningEnum;
        Specific: VersioningEnum;
    };
}
