 ...
 */
export declare class TestReportParticipant {
    /**
     ...
     */
    type?: TestReportParticipant.TypeEnum;
    /**
...
export declare namespace TestReportParticipant {
    type TypeEnum = 'test-engine' | 'client' | 'server';
    const TypeEnum: {
        TestEngine: TypeEnum;
        Client: TypeEnum;
        Server: TypeEnum;
