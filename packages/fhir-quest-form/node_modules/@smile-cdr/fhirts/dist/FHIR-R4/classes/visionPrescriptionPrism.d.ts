 ...
 */
export declare class VisionPrescriptionPrism {
    /**
     ...
     */
    base?: VisionPrescriptionPrism.BaseEnum;
}
export declare namespace VisionPrescriptionPrism {
    type BaseEnum = 'up' | 'down' | 'in' | 'out';
    const BaseEnum: {
        Up: BaseEnum;
        Down: BaseEnum;
        In: BaseEnum;
