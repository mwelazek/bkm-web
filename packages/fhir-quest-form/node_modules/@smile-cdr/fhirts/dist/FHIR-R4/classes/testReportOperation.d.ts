 ...
 */
export declare class TestReportOperation {
    /**
     ...
     */
    result?: TestReportOperation.ResultEnum;
    /**
...
export declare namespace TestReportOperation {
    type ResultEnum = 'pass' | 'skip' | 'fail' | 'warning' | 'error';
    const ResultEnum: {
        Pass: ResultEnum;
        Skip: ResultEnum;
        Fail: ResultEnum;
