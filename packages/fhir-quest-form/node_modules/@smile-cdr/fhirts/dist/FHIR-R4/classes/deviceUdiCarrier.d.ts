 ...
 */
export declare class DeviceUdiCarrier {
    /**
...
export declare namespace DeviceUdiCarrier {
    type EntryTypeEnum = 'barcode' | 'rfid' | 'manual' | 'card' | 'self-reported' | 'unknown';
    const EntryTypeEnum: {
        Barcode: EntryTypeEnum;
        Rfid: EntryTypeEnum;
        Manual: EntryTypeEnum;
        Card: EntryTypeEnum;
        SelfReported: EntryTypeEnum;
        Unknown: EntryTypeEnum;
    };
}
