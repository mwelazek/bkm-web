 ...
 */
export declare class StructureDefinitionContext {
    /**
     ...
     */
    type?: StructureDefinitionContext.TypeEnum;
    /**
     * An expression that defines where an extension can be used in resources.
     */
    expression?: string;
}
export declare namespace StructureDefinitionContext {
    type TypeEnum = 'fhirpath' | 'element' | 'extension';
    const TypeEnum: {
        Fhirpath: TypeEnum;
        Element: TypeEnum;
        Extension: TypeEnum;
