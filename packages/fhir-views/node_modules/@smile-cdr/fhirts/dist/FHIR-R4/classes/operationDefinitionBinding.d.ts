 ...
 */
export declare class OperationDefinitionBinding {
    /**
     ...
     */
    strength?: OperationDefinitionBinding.StrengthEnum;
    /**
     * Points to the value set or external definition (e.g. implicit value set) that identifies the set of codes to be used.
     */
    valueSet: Canonical;
}
export declare namespace OperationDefinitionBinding {
    type StrengthEnum = 'required' | 'extensible' | 'preferred' | 'example';
    const StrengthEnum: {
        Required: StrengthEnum;
        Extensible: StrengthEnum;
        Preferred: StrengthEnum;
        Example: StrengthEnum;
    };
}
