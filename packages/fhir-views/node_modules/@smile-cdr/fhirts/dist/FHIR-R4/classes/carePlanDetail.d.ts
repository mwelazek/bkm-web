 ...
 */
export declare class CarePlanDetail {
    /**
...
export declare namespace CarePlanDetail {
    type StatusEnum = 'not-started' | 'scheduled' | 'in-progress' | 'on-hold' | 'completed' | 'cancelled' | 'stopped' | 'unknown' | 'entered-in-error';
    const StatusEnum: {
        NotStarted: StatusEnum;
