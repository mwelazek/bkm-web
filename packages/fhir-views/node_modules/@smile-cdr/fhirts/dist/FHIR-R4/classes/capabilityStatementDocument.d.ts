 ...
 */
export declare class CapabilityStatementDocument {
    /**
     ...
     */
    mode?: CapabilityStatementDocument.ModeEnum;
    /**
...
export declare namespace CapabilityStatementDocument {
    type ModeEnum = 'producer' | 'consumer';
    const ModeEnum: {
        Producer: ModeEnum;
        Consumer: ModeEnum;
    };
