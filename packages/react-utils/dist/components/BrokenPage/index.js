...
exports.useHandleBrokenPage = exports.defaultProps = exports.BrokenPage = void 0;
...
var BrokenPage = function BrokenPage(props) {
  ...
  var i18nedErrMessage = errorMessage !== null && errorMessage !== void 0 ? errorMessage : t('Something went wrong');
...
var useHandleBrokenPage = function useHandleBrokenPage() {
  ...
  function handleBrokenPage(error) {
    (0, _notifications.sendErrorNotification)(error.name, error.message);
...
exports.useHandleBrokenPage = useHandleBrokenPage;