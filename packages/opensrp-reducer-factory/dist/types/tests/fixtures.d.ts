...
export declare const fetchANC: (objectsList?: ANCClientType[], overwrite?: boolean) => import("..").FetchAction<ANCClientType>;
...
export declare const getAllANCById: (state: Partial<import("redux").Store<any, import("redux").AnyAction>>) => import("@onaio/utils").Dictionary<ANCClientType>;
