 ...
 */
export declare class EncounterLocation {
    /**
     ...
     */
    status?: EncounterLocation.StatusEnum;
    /**
...
export declare namespace EncounterLocation {
    type StatusEnum = 'planned' | 'active' | 'reserved' | 'completed';
    const StatusEnum: {
        Planned: StatusEnum;
        Active: StatusEnum;
        Reserved: StatusEnum;
