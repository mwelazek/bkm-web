...
export declare class Distance {
     ...
     */
    comparator?: Distance.ComparatorEnum;
    /**
...
export declare namespace Distance {
    ...
    const ComparatorEnum: {
        LessThan: ComparatorEnum;
        LessThanOrEqualTo: ComparatorEnum;
        GreaterThanOrEqualTo: ComparatorEnum;
        GreaterThan: ComparatorEnum;
    };
}
