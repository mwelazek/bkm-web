 ...
 */
export declare class GraphDefinitionCompartment {
    /**
     ...
     */
    use?: GraphDefinitionCompartment.UseEnum;
    /**
     ...
     */
    rule?: GraphDefinitionCompartment.RuleEnum;
    /**
...
export declare namespace GraphDefinitionCompartment {
    type UseEnum = 'condition' | 'requirement';
    const UseEnum: {
        Condition: UseEnum;
        Requirement: UseEnum;
    };
    type RuleEnum = 'identical' | 'matching' | 'different' | 'custom';
    const RuleEnum: {
        Identical: RuleEnum;
        Matching: RuleEnum;
        Different: RuleEnum;
