 ...
 */
export declare class QuestionnaireEnableWhen {
    /**
...
export declare namespace QuestionnaireEnableWhen {
    type OperatorEnum = 'exists' | '=' | '!=' | '>' | '<' | '>=' | '<=';
    const OperatorEnum: {
        Exists: OperatorEnum;
        Equal: OperatorEnum;
        ...
        GreaterThanOrEqualTo: OperatorEnum;
        LessThanOrEqualTo: OperatorEnum;
    };
}
