...
export declare class PersonLink {
     ...
     */
    assurance?: PersonLink.AssuranceEnum;
}
export declare namespace PersonLink {
    type AssuranceEnum = 'level1' | 'level2' | 'level3' | 'level4';
    const AssuranceEnum: {
        Level1: AssuranceEnum;
        Level2: AssuranceEnum;
        Level3: AssuranceEnum;
        Level4: AssuranceEnum;
    };
}
