 ...
 */
export declare class ProvenanceEntity {
    /**
     ...
     */
    role?: ProvenanceEntity.RoleEnum;
    /**
...
export declare namespace ProvenanceEntity {
    type RoleEnum = 'derivation' | 'revision' | 'quotation' | 'source' | 'removal';
    const RoleEnum: {
        Derivation: RoleEnum;
        Revision: RoleEnum;
        Quotation: RoleEnum;
