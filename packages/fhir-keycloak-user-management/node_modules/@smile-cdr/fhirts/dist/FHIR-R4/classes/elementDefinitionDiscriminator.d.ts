 ...
 */
export declare class ElementDefinitionDiscriminator {
    /**
     ...
     */
    type?: ElementDefinitionDiscriminator.TypeEnum;
    /**
...
export declare namespace ElementDefinitionDiscriminator {
    type TypeEnum = 'value' | 'exists' | 'pattern' | 'type' | 'profile';
    const TypeEnum: {
        Value: TypeEnum;
        Exists: TypeEnum;
        Pattern: TypeEnum;
