...
export declare namespace QuestionnaireItem {
    type TypeEnum = 'group' | 'display' | 'boolean' | 'decimal' | 'integer' | 'date' | 'dateTime' | 'time' | 'string' | 'text' | 'url' | 'choice' | 'open-choice' | 'attachment' | 'reference' | 'quantity';
    const TypeEnum: {
        Group: TypeEnum;
        Display: TypeEnum;
        Boolean: TypeEnum;
    ...
    type EnableBehaviorEnum = 'all' | 'any';
    const EnableBehaviorEnum: {
        All: EnableBehaviorEnum;
        Any: EnableBehaviorEnum;
    };
}
